...
const INITIAL_PROJECTS: CMSProject[] = [
  {
    ...
    overview_en: "Suhar Advertising was commissioned to design, engineer, fabricate, and install a monumental illuminated facade signage system for Al-Fanar Tower. Situated along one of Muscat's busiest arterial thoroughfares, the project required bold visual prestige that remained crystal clear in direct sunlight and radiated brilliant illumination through the night.",
    overview_ar: "تم تكليف شركة شهار للإعلان بتصميم وهندسة وتصنيع وتركيب نظام لافتات واجهة ضخم ومضيء لبرج الفنار. يقع البرج على أحد أكثر المحاور المرورية حيوية في مسقط، وتطلب المشروع حضوراً بصرياً فخماً يظهر بوضوح تحت أشعة الشمس المباشرة ويتألق بإضاءة ساطعة طوال الليل.",
    challenge_en: "Coastal humidity, intense solar heat, and high wind loads at tower elevation presented stringent durability and weight demands. The lettering required architectural-grade materials that would maintain lustrous polish without corrosion or color fading.",
    challenge_ar: "فرضت الرطوبة الساحلية والحرارة العالية والرياح على ارتفاعات البرج معايير صارمة للمتانة ومقاومة التآكل، وتطلبت الحروف خامات معمارية رفيعة المستوى تحافظ على بريقها وجمالها دون بهتان.",
    solution_en: "We utilized precision laser-cut marine-grade stainless steel with internal reinforced subframes and IP68-rated sealed LED clusters. Our certified installation team executed the mounting safely using precision crane rigs, ensuring seamless structural anchorage and flawless electrical routing.",
    solution_ar: "استخدمنا الفولاذ المقاوم للصدأ البحري المقطوع بالليزر عالي الدقة مع هياكل داخلية مدعمة ووحدات ليد معزولة بمعيار IP68. قام فريق التركيب المعتمد بتنفيذ العمل بأعلى معايير السلامة لضمان التثبيت الهندسي المثالي.",
    deliverables_en: [
  ...
  },
  {
    ...
    overview_en: "Muscat Retail Group needed a unified, modern corporate identity that reflected their growth and commitment to premium customer experiences. Suhar Advertising delivered an end-to-end branding overhaul, harmonizing stationery, digital assets, interior workspace environments, and retail points of sale.",
    overview_ar: "احتاجت مجموعة مسقط للتجزئة إلى هوية مؤسسية موحدة وعصرية تعكس نموها المستمر والتزامها بتقديم تجارب تسوق راقية. قدمت شهار للإعلان هوية متكاملة شملت المطبوعات، المساحات الداخلية، ونقاط البيع المختلفة.",
    challenge_en: "Aligning multiple sub-brands across disparate retail sectors under a single, coherent design system while preserving brand recall across physical and digital touchpoints.",
    challenge_ar: "توحيد عدة علامات تجارية فرعية تحت نظام تصميمي واحد ومتناسق مع الحفاظ على تميز كل قطاع في جميع نقاط الاتصال.",
    solution_en: "We developed a modular design language inspired by warm Omani geometry, executed across embossed print collateral, frosted privacy graphics, acrylic interior signage, and sleek executive merchandise.",
    solution_ar: "قمنا بتطوير لغة تصميمية حديثة مستوحاة من التراث العُماني الأنيق، وطبقناها عبر مطبوعات بارزة، لافتات أكريليك داخلية، ومواد تسويقية فاخرة.",
    deliverables_en: [
  ...
  },
  {
    ...
    overview_en: "For the landmark Oman Expo 2025 promotional campaign, Suhar Advertising engineered and deployed large-scale outdoor LED digital screens that captured the attention of millions of commuters and visitors across Muscat's key transit hubs.",
    overview_ar: "ضمن الحملة الترويجية الكبرى لإكسبو عُمان 2025، قامت شركة شهار للإعلان بتجهيز وتركيب شاشات LED رقمية عملاقة جذبت أنظار ملايين المسافرين والزوار عبر المحاور الرئيسية في مسقط.",
    challenge_en: "Ensuring 24/7 crystal-clear visibility under blinding midday Arabian sunlight and extreme ambient temperatures while maintaining fluid video playback and remote content synchronization.",
    challenge_ar: "ضمان وضوح الشاشات على مدار 24 ساعة تحت أشعة الشمس الساطعة والحرارة الشديدة، مع استقرار بث الفيديو والتحديث الفوري للمحتوى.",
    solution_en: "We deployed 7,500-nit high-refresh rate LED panels with automated ambient light sensors and dual-circuit climate cooling, controlled via secure cloud-based content servers.",
    solution_ar: "استخدمنا لوحات ليد بسطوع 7,500 شمعة مع حساسات إضاءة محيطية وتبريد داخلي مزدوج يتم التحكم فيها سحابياً عن بُعد.",
    deliverables_en: [
  ...
  },
  {
    ...
    overview_en: "Transforming a fleet of over 60 commercial transport vehicles into mobile brand beacons across Oman's national highway network.",
    overview_ar: "تحويل أسطول يضم أكثر من 60 مركبة نقل تجارية إلى واجهات إعلانية متنقلة تجوب كافة محافظات سلطنة عُمان.",
    challenge_en: "High UV exposure and highway gravel impact required ultra-durable vinyl films and precise contour wrapping.",
    challenge_ar: "تطلبت الظروف الصحراوية والحرارة الشديدة استخدام أفلام فينيل فائقة المقاومة وعوازل متطورة للأشعة فوق البنفسجية.",
    solution_en: "Cast vinyl graphics with ultra-durable matte laminate, applied in dust-controlled bays.",
    solution_ar: "تنفيذ تجليد احترافي باستخدام فينيل مصبوب عالي الجودة مع طبقة حماية مطفية مقاومة للخدوش في ورش معزولة.",
    deliverables_en: ["Full & Partial Cast Fleet Wraps", "Reflective Highway Safety Markings", "Scratch-Resistant UV Overlaminate"],
    deliverables_ar: ["تجليد كامل وجزئي عالي المتانة", "ملصقات فسفورية عاكسة للسلامة", "طبقات حماية شفافة عازلة للأشعة"],
    impact_en: ["Fleet rollout completed in 18 days", "Estimated 120,000 daily road impressions"],
    impact_ar: ["إنجاز الأسطول بالكامل خلال 18 يوماً", "أكثر من 120 ألف مشاهدة يومية"],
  ...
  },
  {
    ...
    overview_en: "Design, turnkey fabrication, and lighting engineering for a 350 sq. meter flagship pavilion at OCEC.",
    overview_ar: "تصميم وتصنيع وتنفيذ جناح متكامل بمساحة 350 متراً مربعاً بأحدث أنظمة الإضاءة والمجسمات ثلاثية الأبعاد.",
    challenge_en: "Tight 48-hour build window inside the exhibition hall with complex electrical rigging.",
    challenge_ar: "فترة تركيب قصيرة لا تتجاوز 48 ساعة داخل قاعة المعرض مع متطلبات إضاءة وهياكل معقدة.",
    solution_en: "Modular CNC-pre-fabricated structural components engineered for rapid assembly and seamless finish.",
    solution_ar: "تصنيع هياكل مسبقة التجهيز بتقنيات CNC لضمان سرعة التركيب والدقة المطلقة دون أي فواصل.",
    deliverables_en: ["Custom Architectural Pavilion", "RGB Dynamic Ambient Illumination", "Acrylic Showcase Display Units"],
    deliverables_ar: ["جناح معماري فاخر مخصص", "إضاءة RGB ديناميكية تفاعلية", "منصات عرض أكريليك مخصصة"],
    impact_en: ["Rated most visited pavilion of the exhibition", "100% on-time delivery before VIP inauguration"],
    impact_ar: ["الجناح الأكثر زيارة خلال فترة المعرض", "تسليم كامل قبل موعد الافتتاح الرسمي"],
  ...
  },
  {
    ...
    overview_en: "Delivering over 250,000 units of annual marketing reports, executive brochures, and customized branded stationery.",
    overview_ar: "إنتاج أكثر من 250 ألف مطبوعة سنوية تشمل التقارير المالية والكتيبات الفاخرة والمطبوعات المؤسسية.",
    challenge_en: "Strict CMYK brand color fidelity across different textured stocks and luxury foiling techniques.",
    challenge_ar: "مطابقة درجات الألوان بدقة متناهية عبر خامات ورقية متنوعة مع تقنيات البصمة الذهبية والحرارية.",
    solution_en: "Computer-to-plate Heidelberg offset printing with spectrophotometric density control and soft-touch lamination.",
    solution_ar: "طباعة أوفست متطورة بنظام ضبط الكثافة اللونية مع طبقات لمس ناعمة وبصمة ذهبية بارزة.",
    deliverables_en: ["Executive Annual Report Books", "Foil-Stamped Corporate Presentation Kits", "Luxury Packaging Boxes"],
    deliverables_ar: ["تقارير سنوية مجلدة فاخرة", "أطقم تقديم مكتبية بالبصمة الذهبية", "علب هدايا وتغليف فاخر"],
    impact_en: ["Zero rejection rate across 250,000 units", "Delivery completed in phased tranches ahead of schedule"],
    impact_ar: ["دقة طباعة 100% دون أي هدر", "تسليم كافة الشحنات قبل المواعيد المحددة"],
...
const INITIAL_TESTIMONIALS: CMSTestimonial[] = [
  {
    ...
    text_en: "SUHAR reimagined our entire retail identity — every store now feels unmistakably ours. Craftsmanship is world-class.",
    text_ar: "أعاد شهار تخيّل هويتنا بالكامل — كل فرع أصبح يعبّر عنّا بوضوح. حرفية عالمية المستوى.",
    rating: 5,
    is_published: true,
    display_order: 1,
    updated_at: new Date().toISOString(),
  },
  {
    ...
    text_en: "From concept to fleet-wide rollout, the team delivered ahead of schedule. Our vehicles are our best billboards now.",
    text_ar: "من الفكرة إلى تجهيز الأسطول، سلّم الفريق قبل الموعد. مركباتنا أصبحت أفضل لوحاتنا.",
    rating: 5,
    is_published: true,
    display_order: 2,
    updated_at: new Date().toISOString(),
  },
  {
    ...
    text_en: "Their exhibition build was the talk of the show. Precision, lighting, presence — everything we hoped for.",
    text_ar: "ستاندنا كان حديث المعرض. دقّة وإضاءة وحضور — تماماً كما تمنّينا.",
    rating: 5,
    is_published: true,
    display_order: 3,
    updated_at: new Date().toISOString(),
...
function getLocalStore(): CMSStoreData {
  try {
    ...
    if (!fs.existsSync(DATA_FILE_PATH)) {
      ...
      fs.writeFileSync(DATA_FILE_PATH, JSON.stringify(initialStore, null, 2), "utf8");
      return initialStore;
    }
...
export async function getCMSProjectById(id: string): Promise<CMSProject | null> {
  const projects = await getCMSProjects();
  return projects.find((p) => p.id === id) || null;
}

export async function saveCMSProject(data: Partial<CMSProject> & { id?: string }): Promise<CMSProject> {
  const store = getLocalStore();
  const now = new Date().toISOString();
  const id = data.id || `proj-${Date.now()}`;

  // Look up existing record to prevent breaking slugs and overwriting custom Arabic content
  let existing: CMSProject | undefined = store.projects.find((p) => p.id === id);
  if (!existing && isFirebaseConfigured() && firestore) {
    try {
      const snap = await getDoc(doc(firestore, "projects", id));
      if (snap.exists()) {
        existing = { id: snap.id, ...snap.data() } as CMSProject;
      }
    } catch {}
  }

  // Preserve existing slug when editing, or generate URL-safe collision-free slug for new project
  ...
  if (!slug) {
    ...
    // Check for collision with any other project
    const otherProjects = store.projects.filter((p) => p.id !== id);
    if (otherProjects.some((p) => p.slug === slug)) {
      slug = `${slug}-${Date.now().toString().slice(-4)}`;
    }
  }

  // Auto-translate only if Arabic was not provided AND did not exist previously
  const title_en = data.title_en?.trim() || existing?.title_en || "Untitled Project";
  const title_ar = data.title_ar?.trim() && data.title_ar !== "مشروع جديد" 
    ? data.title_ar 
    : existing?.title_ar || (await translateEnglishToArabic(title_en));

  const subtitle_en = data.subtitle_en !== undefined ? data.subtitle_en.trim() : (existing?.subtitle_en || "");
  const subtitle_ar = data.subtitle_ar?.trim()
    ? data.subtitle_ar
    : existing?.subtitle_ar || (subtitle_en ? await translateEnglishToArabic(subtitle_en) : "");

  const client_en = data.client_en !== undefined ? data.client_en.trim() : (existing?.client_en || "Client");
  const client_ar = data.client_ar?.trim() && data.client_ar !== "العميل"
    ? data.client_ar
    : existing?.client_ar || (await translateEnglishToArabic(client_en));

  const location_en = data.location_en !== undefined ? data.location_en.trim() : (existing?.location_en || "Muscat, Oman");
  const location_ar = data.location_ar?.trim() && data.location_ar !== "مسقط، عُمان"
    ? data.location_ar
    : existing?.location_ar || (await translateEnglishToArabic(location_en));

  const overview_en = data.overview_en !== undefined ? data.overview_en.trim() : (existing?.overview_en || "");
  const overview_ar = data.overview_ar?.trim()
    ? data.overview_ar
    : existing?.overview_ar || (overview_en ? await translateEnglishToArabic(overview_en) : "");

  const challenge_en = data.challenge_en !== undefined ? data.challenge_en.trim() : (existing?.challenge_en || "");
  const challenge_ar = data.challenge_ar?.trim()
    ? data.challenge_ar
    : existing?.challenge_ar || (challenge_en ? await translateEnglishToArabic(challenge_en) : "");

  const solution_en = data.solution_en !== undefined ? data.solution_en.trim() : (existing?.solution_en || "");
  const solution_ar = data.solution_ar?.trim()
    ? data.solution_ar
    : existing?.solution_ar || (solution_en ? await translateEnglishToArabic(solution_en) : "");

  let deliverables_en = Array.isArray(data.deliverables_en) ? data.deliverables_en : (existing?.deliverables_en || []);
  let deliverables_ar = Array.isArray(data.deliverables_ar) && data.deliverables_ar.length > 0 
    ? data.deliverables_ar 
    : (existing?.deliverables_ar || []);
  if (deliverables_ar.length === 0 && deliverables_en.length > 0) {
    deliverables_ar = await Promise.all(deliverables_en.map((d) => translateEnglishToArabic(d)));
  }

  let impact_en = Array.isArray(data.impact_en) ? data.impact_en : (existing?.impact_en || []);
  let impact_ar = Array.isArray(data.impact_ar) && data.impact_ar.length > 0 
    ? data.impact_ar 
    : (existing?.impact_ar || []);
  if (impact_ar.length === 0 && impact_en.length > 0) {
    impact_ar = await Promise.all(impact_en.map((d) => translateEnglishToArabic(d)));
  }

  const category_slug = data.category_slug || data.category || existing?.category_slug || existing?.category || "Signage";
  ...
  const project: CMSProject = {
    ...
    client_en,
    client_ar,
    year: data.year || existing?.year || new Date().getFullYear().toString(),
    location_en,
    location_ar,
    overview_en,
    overview_ar,
...
export async function saveCMSCategory(data: Partial<Category> & { id?: string }): Promise<Category> {
  ...
  if (isFirebaseConfigured() && firestore) {
    try {
      await setDoc(doc(firestore, "categories", id), category, { merge: true });
    } catch (e) {
...
export async function getCMSSettings(): Promise<CMSSettings> {
  if (isFirebaseConfigured() && firestore) {
    try {
      const snap = await getDoc(doc(firestore, "settings", "website"));
      if (snap.exists()) {
        const data = snap.data() as CMSSettings;
        return { testimonial_display_count: data.testimonial_display_count ?? 3 };
      }
    } catch (e) {
  ...
  const store = getLocalStore();
  return store.settings || { testimonial_display_count: 3 };
}

export async function saveCMSSettings(data: Partial<CMSSettings>): Promise<CMSSettings> {
  const store = getLocalStore();
  const settings: CMSSettings = {
    ...(store.settings || { testimonial_display_count: 3 }),
    ...data,
  };

  if (isFirebaseConfigured() && firestore) {
    try {
      await setDoc(doc(firestore, "settings", "website"), settings, { merge: true });
    } catch (e) {
...
export async function getCMSTestimonials(onlyPublished = false, limitCount?: number): Promise<CMSTestimonial[]> {
  ...
  list.sort((a, b) => {
    const diff = (a.display_order ?? 999) - (b.display_order ?? 999);
...
export async function saveCMSTestimonial(data: Partial<CMSTestimonial> & { id?: string }): Promise<CMSTestimonial> {
  const store = getLocalStore();
  const id = data.id || `test-${Date.now()}`;
  const now = new Date().toISOString();

  let existing: CMSTestimonial | undefined = store.testimonials.find((t) => t.id === id);

  if (!existing && isFirebaseConfigured() && firestore) {
    try {
      const snap = await getDoc(doc(firestore, "testimonials", id));
      if (snap.exists()) {
        existing = { id: snap.id, ...snap.data() } as CMSTestimonial;
      }
    } catch {}
  }

  const person_name_en = data.person_name_en !== undefined ? data.person_name_en.trim() : (existing?.person_name_en || "Client Name");
  const person_name_ar = data.person_name_ar?.trim() && data.person_name_ar !== "اسم العميل"
    ? data.person_name_ar
    : existing?.person_name_ar || (await translateEnglishToArabic(person_name_en));

  const designation_en = data.designation_en !== undefined ? data.designation_en.trim() : (existing?.designation_en || "Manager");
  const designation_ar = data.designation_ar?.trim() && data.designation_ar !== "المنصب"
    ? data.designation_ar
    : existing?.designation_ar || (await translateEnglishToArabic(designation_en));

  const company_en = data.company_en !== undefined ? data.company_en.trim() : (existing?.company_en || "Company");
  const company_ar = data.company_ar?.trim() && data.company_ar !== "الشركة"
    ? data.company_ar
    : existing?.company_ar || (await translateEnglishToArabic(company_en));

  const text_en = data.text_en !== undefined ? data.text_en.trim() : (existing?.text_en || "");
  const text_ar = data.text_ar?.trim()
    ? data.text_ar
    : existing?.text_ar || (text_en ? await translateEnglishToArabic(text_en) : "");
  ...
  const testimonial: CMSTestimonial = {
    ...
    text_en,
    text_ar,
    rating: data.rating ?? existing?.rating ?? 5,
    photo_url: data.photo_url ?? existing?.photo_url ?? "",
    is_published: data.is_published ?? existing?.is_published ?? true,
    display_order: data.display_order ?? existing?.display_order ?? (store.testimonials.length + 1),
    updated_at: now,
  };
...
export async function saveCMSClient(data: Partial<CMSClientLogo> & { id?: string }): Promise<CMSClientLogo> {
  const store = getLocalStore();
  const id = data.id || `client-${Date.now()}`;
  const now = new Date().toISOString();

  const name_en = data.name_en?.trim() || "Client Brand";
  const name_ar = data.name_ar?.trim() && data.name_ar !== "اسم الشركة"
    ? data.name_ar
    : await translateEnglishToArabic(name_en);
  ...
  const client: CMSClientLogo = {
    ...
    display_order: data.display_order ?? (store.clients.length + 1),
  ...
  if (isFirebaseConfigured() && firestore) {
    try {
      ...
      console.warn("Firestore save client error:", e);
    }
  }
...
// SEED LIVE FIRESTORE
// -------------------------------------------------------------
export async function seedFirestoreWithInitialData(): Promise<{ success: boolean; counts: Record<string, number> }> {
  if (!isFirebaseConfigured() || !firestore) {
    throw new Error("Firebase is not configured");
  }
  const store = getLocalStore();
  const counts = { categories: 0, projects: 0, testimonials: 0, clients: 0 };
  ...
  for (const test of store.testimonials) {
    await setDoc(doc(firestore, "testimonials", test.id), test, { merge: true });
    counts.testimonials++;
  }
  for (const client of store.clients) {
    await setDoc(doc(firestore, "clients", client.id), client, { merge: true });
    counts.clients++;
  }
